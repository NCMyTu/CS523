1. Dùng entropy để vẽ cây quyết định với dataset cho trong file ***hw_dataset_1.csv***, biến mục tiêu là HEART ATTACK. Lưu ý **PATIENT ID** là thuộc tính dạng rời rạc.
